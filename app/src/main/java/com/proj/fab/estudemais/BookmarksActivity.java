...
import com.proj.fab.estudemais.Adapters.AnswersAdapter;
import com.proj.fab.estudemais.Adapters.BookmarkAdapter;
...
public class BookmarksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       Toolbar toolbar=findViewById(R.id.ba_toolbar);
        ...
        getSupportActionBar().setTitle("Questões salvas");
